...
class AD extends Component {
	...
	async submitToBlockchain(event) {
		...
		const response = await axios.post(`http://localhost:5000/api/status/`, status);
	}
				...
				{showApplication ? (
					<div>
						<Card style={{ margin: '10px', padding: '10px' }}>
							<h3 style={{ textAlign: 'center', color: 'gray', margin: '10px' }}>
								Application for an Aerodrome Application
							</h3>
							<Row>
								<Col md={6}>
									<Card style={{ margin: '10px', padding: '10px' }}>
										<CardHeader>
											...
											<h6 style={{ color: 'gray', display: 'inline' }}>
												(As required to be shown on the License)
											</h6>
										</CardHeader>
										<CardBody>
											<Row>
												<Col md={6}>
													<Input type="text" placeholder="Name of the Applicant" />
												</Col>
												<Col md={6}>
													<Input type="email" placeholder="Email of the Applicant" />
												</Col>
											</Row>
											<Row style={{ marginTop: '20px' }}>
												...
												<Col md={6}>
													<Input text="email" placeholder="Nationality of the Applicant" />
												</Col>
											</Row>
										</CardBody>
									</Card>
									...
									<Card style={{ margin: '10px', padding: '10px' }}>
										...
										<CardBody>
											...
											<Row>
												<Col md={6}>
													<p>
														If No please specify when this is likely to be submitted to DGCA
													</p>
												</Col>
												<Col md={6}>
									...
									<Card style={{ margin: '10px', padding: '10px' }}>
										...
										<CardBody>
											<Row>
												<Col md={6}>
													<p>
														Place name by which the Aerodrome is to be known in all future
														reference
													</p>
												</Col>
												<Col md={6}>
											...
											<Row>
												<Col md={6}>
													<p>
														Situation of the Aerodrome Site with reference to the nearest
														Airport, Railway Station & Town/Village
													</p>
												</Col>
												<Col md={6}>
									...
									<Card style={{ margin: '10px', padding: '10px' }}>
										...
										<CardBody>
											<Row>
												<Col md={6}>
													<Label>
														State category of licence required as defined in Aircraft Rules
														1937?
													</Label>
												</Col>
												<Col md={6}>
											...
											<Row>
												<Col md={6}>
													<p>
														If the answer of above is YES, Please provide details of
														proposed lighting along with the lighting plan.
													</p>
												</Col>
												<Col md={6}>
													<TextArea row={4} type="text" style={{ padding: '5px' }} />
							...
							<Col md={6}>
								<Card>
									<Descriptions title="Application Info" style={{ padding: '10px' }} bordered>
										<Descriptions.Item label="Airport Code">AGX</Descriptions.Item>
										<Descriptions.Item label="Airport Name" span={2}>
											Agatti Airport
										</Descriptions.Item>
										<Descriptions.Item label="Lattitude">10.8281° N</Descriptions.Item>
										...
										<Descriptions.Item label="Status" span={3}>
											...
											<Button color="success">License Granted</Button>
